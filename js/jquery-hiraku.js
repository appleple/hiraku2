...
},{"scroll-to":16}],16:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"raf":3,"tween":4}],17:[function(require,module,exports){
'use strict';
...
var applyJQuery = function applyJQuery(jQuery) {
  jQuery.fn.hiraku = function (settings) {
    if (typeof settings === 'string') {} else {
...
var isAndroid = (0, _lib.isNativeAndroid)();
  ...
  _createClass(Hiraku, [{
    ...
    value: function open() {
      ...
      if (direction === 'right') {
        ...
        if (isAndroid) {
          (0, _lib.addClass)(body, 'js-hiraku-offcanvas-body-right-android');
        }
      } else {
        (0, _lib.addClass)(body, 'js-hiraku-offcanvas-body-left');
        if (isAndroid) {
          (0, _lib.addClass)(body, 'js-hiraku-offcanvas-body-left-android');
        }
      }
      ...
      if (fixed) {
        if (this.isIE) {
          ...
          fixed.style.webkitTransform = 'translateY(' + (0, _lib.getScrollTop)() + 'px)';
        }
      }
      this.scrollAmount = 0;
      ...
      if (direction === 'right') {
        if (this.isIE) {
          ...
          side.style.webkitTransform = 'translateX(100%) translateY(' + (0, _lib.getScrollTop)() + 'px)';
        }
      } else if (this.isIE) {
        side.style.transform = 'translateX(0px)';
    ...
    value: function close() {
      ...
      if (direction === 'right') {
        ...
        if (isAndroid) {
          (0, _lib.removeClass)(body, 'js-hiraku-offcanvas-body-right-android');
        }
      } else {
        (0, _lib.removeClass)(body, 'js-hiraku-offcanvas-body-left-android');
        if (isAndroid) {
          (0, _lib.removeClass)(body, 'js-hiraku-offcanvas-body-left-android');
        }
      }
    ...
    value: function _resizeHandler() {
      ...
      if (breakpoint === -1 || breakpoint >= windowWidth) {
        ...
        if (isAndroid) {
          (0, _lib.addClass)(body, 'js-hiraku-offcanvas-body-android-active');
        }
      } else {
        (0, _lib.removeClass)(body, 'js-hiraku-offcanvas-body-active');
        if (isAndroid) {
          (0, _lib.removeClass)(body, 'js-hiraku-offcanvas-body-android-active');
        }
      }
      this.close();
    }
...
},{"../lib":20,"custom-event-polyfill":6,"debounce":7,"es6-object-assign/auto":9,"raf/polyfill":14,"scroll-to-element":15}],19:[function(require,module,exports){
'use strict';
...
var isNativeAndroid = exports.isNativeAndroid = function isNativeAndroid() {
